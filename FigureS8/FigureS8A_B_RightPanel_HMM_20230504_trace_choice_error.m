...
function FigureS8A_B_RightPanel_HMM_20230504_trace_choice_error

%repeat
process_HMM_20230504_trace_at_choice_ver2_depth_error('repeat_OFC_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('repeat_Hippo_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('repeat_AC_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('repeat_PPC_20240427');

%altern
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_OFC_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_Hippo_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_AC_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_PPC_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_M1_20240427');
process_HMM_20230504_trace_at_choice_ver2_depth_error('altern_STR_20240427');

return


function process_HMM_20230504_trace_at_choice_ver2_depth_error(folders, kaiseki_number)
