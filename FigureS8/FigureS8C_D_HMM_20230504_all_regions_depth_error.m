...
function FigureS8C_D_HMM_20230504_all_regions_depth_error

%repeat
[repeat_OFC_prefer, repeat_OFC_nonprefer, repeat_p(3,:), repeat_neuron(3)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('repeat_OFC_20240427');
[repeat_Hippo_prefer, repeat_Hippo_nonprefer, repeat_p(2,:), repeat_neuron(2)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('repeat_Hippo_20240427');
[repeat_AC_prefer, repeat_AC_nonprefer, repeat_p(1,:), repeat_neuron(1)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('repeat_AC_20240427');
[repeat_PPC_prefer, repeat_PPC_nonprefer, repeat_p(4,:), repeat_neuron(4)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('repeat_PPC_20240427');

%zigzag
[zigzag_OFC_prefer, zigzag_OFC_nonprefer, zigzag_p(3,:), zigzag_neuron(3)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_OFC_20240427');
[zigzag_Hippo_prefer, zigzag_Hippo_nonprefer, zigzag_p(2,:), zigzag_neuron(2)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_Hippo_20240427');
[zigzag_AC_prefer, zigzag_AC_nonprefer, zigzag_p(1,:), zigzag_neuron(1)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_AC_20240427');
[zigzag_PPC_prefer, zigzag_PPC_nonprefer, zigzag_p(4,:), zigzag_neuron(4)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_PPC_20240427');
[zigzag_M1_prefer, zigzag_M1_nonprefer, zigzag_p(5,:), zigzag_neuron(5)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_M1_20240427');
[zigzag_STR_prefer, zigzag_STR_nonprefer, zigzag_p(6,:), zigzag_neuron(6)] = process_HMM_20230504_surprise_at_choice_all_regions_depth_error('altern_STR_20240427');
...
title('During choice-Error trials(Repeating condition)')
...
ylim([-2.5 2.5])
ylabel('Repeat - Alterante')
title('During choice-Error trials (Alternating condition)')
set(gca,'FontName', 'Arial')
set(gcf,'Position',[389,433,1044,360])

function [prefer_sabunError, nonprefer_sabunError, p_sabunError, length_neuron] = ...
   process_HMM_20230504_surprise_at_choice_all_regions_depth_error(folders, kaiseki_number)
...
[~, ~, Lsig_PostLow_leftError, Lsig_PostHigh_leftError, Lsig_pLeft] = ...
    test_surprise_at_choice(all_norm_spike, left_sig_neuron, left_choice_matrix, all_p_surprise(:,left_surprise));
[~, ~, Lsig_PostLow_rightError, Lsig_PostHigh_rightError, Lsig_pRight] = ...
    test_surprise_at_choice(all_norm_spike, left_sig_neuron, right_choice_matrix, all_p_surprise(:,right_surprise));

[~, ~, Rsig_PostLow_leftError, Rsig_PostHigh_leftError, Rsig_pLeft] = ...
    test_surprise_at_choice(all_norm_spike, right_sig_neuron, left_choice_matrix, all_p_surprise(:,left_surprise));
[~, ~, Rsig_PostLow_rightError, Rsig_PostHigh_rightError, Rsig_pRight] = ...
    test_surprise_at_choice(all_norm_spike, right_sig_neuron, right_choice_matrix, all_p_surprise(:,right_surprise));


Repeat_preferError = [Lsig_PostLow_leftError; Rsig_PostHigh_rightError];
Repeat_nonpreferError = [Lsig_PostHigh_rightError; Rsig_PostLow_leftError];
Switch_preferError = [Lsig_PostHigh_leftError; Rsig_PostLow_rightError];
Switch_nonpreferError = [Lsig_PostLow_rightError; Rsig_PostHigh_leftError];
P_preferError = [Lsig_pLeft(:,2); Rsig_pRight(:,2)];
P_nonpreferError = [Lsig_pRight(:,2); Rsig_pLeft(:,2)];
P_Error = [P_preferError, P_nonpreferError];

clear P_preferCorrect P_nonpreferCorrect P_preferError P_nonpreferError

[prefer_sabunError, nonprefer_sabunError, p_sabunError] = ...
    plot_surprise_choice(Repeat_preferError, Switch_preferError, Switch_nonpreferError, Repeat_nonpreferError, [0 0 0]);

temp1 = length(prefer_sabunError);
temp2 = length(nonprefer_sabunError);
