...
%repeat
process_HMM_20230504_trace_at_choice_ver2_depth_correct('repeat_OFC_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('repeat_Hippo_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('repeat_AC_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('repeat_PPC_20230427');

%zigzag
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_OFC_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_Hippo_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_AC_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_PPC_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_M1_20230427');
process_HMM_20230504_trace_at_choice_ver2_depth_correct('zigzag_STR_20230427');
...
make_prefer_trace_2(left_sig_neuron, right_sig_neuron, all_choice_trace);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function make_prefer_trace_2(left_sig_neuron, right_sig_neuron, all_sound_trace)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[c_repeat_prefer_l,c_switch_prefer_l,c_switch_nonprefer_l,c_repeat_nonprefer_l, ...
 e_repeat_prefer_l,e_switch_prefer_l,e_switch_nonprefer_l,e_repeat_nonprefer_l] ...
...
[c_repeat_prefer_r,c_switch_prefer_r,c_switch_nonprefer_r,c_repeat_nonprefer_r, ...
 e_repeat_prefer_r,e_switch_prefer_r,e_switch_nonprefer_r,e_repeat_nonprefer_r] ...
...
e_repeat_prefer = [e_repeat_prefer_l; e_repeat_prefer_r];
e_switch_prefer = [e_switch_prefer_l; e_switch_prefer_r];
e_switch_nonprefer = [e_switch_nonprefer_l; e_switch_nonprefer_r];
e_repeat_nonprefer = [e_repeat_nonprefer_l; e_repeat_nonprefer_r];
...
figure(2)
plot_mean_se_moto(e_repeat_prefer,[1 0 0],0) %
hold on
plot_mean_se_moto(e_switch_prefer,[255 102 0]./255,0) %
hold on
plot_mean_se_moto(e_switch_nonprefer,[68 168 40]./255,0) %
hold on
plot_mean_se_moto(e_repeat_nonprefer,[0 0 1],0) %
hold on
plot([2000 2000], ylim, ':')
set(gcf,'Position',[200 200 325 319])
