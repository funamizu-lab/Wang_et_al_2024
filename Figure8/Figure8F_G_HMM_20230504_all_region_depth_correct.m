...
----------------------------------------------------------------------------
%}
function Figure8F_G_process2_HMM_20230504_choice_depth_correct

%repeat
[repeat_OFC_prefer, repeat_OFC_nonprefer, repeat_p(1,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('repeat_OFC_20230427');
[repeat_Hippo_prefer, repeat_Hippo_nonprefer, repeat_p(2,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('repeat_Hippo_20230427');
[repeat_AC_prefer, repeat_AC_nonprefer, repeat_p(3,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('repeat_AC_20230427');
[repeat_PPC_prefer, repeat_PPC_nonprefer, repeat_p(4,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('repeat_PPC_20230427');
%zigzag
[zigzag_OFC_prefer, zigzag_OFC_nonprefer, zigzag_p(1,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_OFC_20230427');
[zigzag_Hippo_prefer, zigzag_Hippo_nonprefer, zigzag_p(2,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_Hippo_20230427');
[zigzag_AC_prefer, zigzag_AC_nonprefer, zigzag_p(3,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_AC_20230427');
[zigzag_PPC_prefer, zigzag_PPC_nonprefer, zigzag_p(4,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_PPC_20230427');
[zigzag_M1_prefer, zigzag_M1_nonprefer, zigzag_p(5,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_M1_20230427');
[zigzag_STR_prefer, zigzag_STR_nonprefer, zigzag_p(6,:), ~] = process_HMM_20230504_surprise_at_choice_ver2_depth_correct('zigzag_STR_20230427');
...
xt = xt - 0.3;
yt = [2 2 2 2 2 2 2 2];
str = {num2str(repeat_p(1,1)),num2str(repeat_p(2,1)),num2str(repeat_p(3,1)),num2str(repeat_p(4,1)),...
    num2str(repeat_p(1,2)),num2str(repeat_p(2,2)),num2str(repeat_p(3,2)),num2str(repeat_p(4,2))};
text(xt,yt,str)
