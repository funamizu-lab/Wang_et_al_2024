...
% % repeat
[repeat_OFC_prefer, repeat_OFC_nonprefer, repeat_p(1,:), ~] = process_HMM_20240710_surprise_before_sound_depth('repeat_OFC_20230427');
[repeat_AC_prefer, repeat_AC_nonprefer, repeat_p(2,:), ~] = process_HMM_20240710_surprise_before_sound_depth('repeat_AC_20230427');

% % zigzag
[zigzag_OFC_prefer, zigzag_OFC_nonprefer, zigzag_p(1,:), ~] = process_HMM_20240710_surprise_before_sound_depth('zigzag_OFC_20230427');
[zigzag_AC_prefer, zigzag_AC_nonprefer, zigzag_p(2,:), ~] = process_HMM_20240710_surprise_before_sound_depth('zigzag_AC_20230427');
[zigzag_PPC_prefer, zigzag_PPC_nonprefer, zigzag_p(3,:), ~] = process_HMM_20240710_surprise_before_sound_depth('zigzag_PPC_20230427');
[zigzag_M1_prefer, zigzag_M1_nonprefer, zigzag_p(4,:), ~] = process_HMM_20240710_surprise_before_sound_depth('zigzag_M1_20230427');
[zigzag_STR_prefer, zigzag_STR_nonprefer, zigzag_p(5,:), ~] = process_HMM_20240710_surprise_before_sound_depth('zigzag_STR_20230427');
...
xt = xt - 0.3;
yt = [2 2 2 2];
str = {num2str(repeat_p(1,1)),num2str(repeat_p(2,1)),num2str(repeat_p(1,2)),num2str(repeat_p(2,2))};
text(xt,yt,str)
...
str = {num2str(zigzag_p(1,1)),num2str(zigzag_p(2,1)),num2str(zigzag_p(3,1)),num2str(zigzag_p(4,1)),num2str(zigzag_p(5,1))...
    num2str(zigzag_p(1,2)),num2str(zigzag_p(2,2)),num2str(zigzag_p(3,2)),num2str(zigzag_p(4,2)),num2str(zigzag_p(5,2))};
text(xt,yt,str)
