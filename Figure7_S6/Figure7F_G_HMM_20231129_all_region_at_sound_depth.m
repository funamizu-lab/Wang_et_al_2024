...
%repeat
[repeat_OFC_prefer, repeat_OFC_nonprefer, repeat_p(1,:), repeat_neuron(1)] = HMM_20230626_surprise_at_sound_depth('repeat_OFC_20240427',2);
[repeat_AC_prefer, repeat_AC_nonprefer, repeat_p(2,:), repeat_neuron(2)] = HMM_20230626_surprise_at_sound_depth('repeat_AC_20240427',2);
[repeat_PPC_prefer, repeat_PPC_nonprefer, repeat_p(3,:), repeat_neuron(3)] = HMM_20230626_surprise_at_sound_depth('repeat_PPC_20240427',2);

%zigzag

[zigzag_OFC_prefer, zigzag_OFC_nonprefer, zigzag_p(1,:), zigzag_neuron(1)] = HMM_20230626_surprise_at_sound_depth('altern_OFC_20240427',2);
[zigzag_Hippo_prefer, zigzag_Hippo_nonprefer, zigzag_p(2,:), zigzag_neuron(2)] = HMM_20230626_surprise_at_sound_depth('altern_Hippo_20240427',2);
[zigzag_AC_prefer, zigzag_AC_nonprefer, zigzag_p(3,:), zigzag_neuron(3)] = HMM_20230626_surprise_at_sound_depth('altern_AC_20240427',2);
[zigzag_PPC_prefer, zigzag_PPC_nonprefer, zigzag_p(4,:), zigzag_neuron(4)] = HMM_20230626_surprise_at_sound_depth('altern_PPC_20240427',2);
[zigzag_M1_prefer, zigzag_M1_nonprefer, zigzag_p(5,:), zigzag_neuron(5)] = HMM_20230626_surprise_at_sound_depth('altern_M1_20240427',2);
[zigzag_STR_prefer, zigzag_STR_nonprefer, zigzag_p(6,:), zigzag_neuron(6)] = HMM_20230626_surprise_at_sound_depth('altern_STR_20240427',2);
