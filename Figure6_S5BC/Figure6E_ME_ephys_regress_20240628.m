function Figure6E_ME_ephys_regress_20240628(root_dir)

tic
% presound sound
[Coef_OFC_presound,~,p_prefer_presound(1,:),p_nonprefer_presound(1,:)] = ...
    process_ME_ephys_regress_step1_20240628('altern_OFC_20240427',root_dir,1);
[Coef_AC_presound,~,p_prefer_presound(2,:),p_nonprefer_presound(2,:)] = ...
    process_ME_ephys_regress_step1_20240628('altern_AC_20240427',root_dir,1);
[Coef_PPC_presound,~,p_prefer_presound(3,:),p_nonprefer_presound(3,:)] = ...
    process_ME_ephys_regress_step1_20240628('altern_PPC_20240427',root_dir,1);
[Coef_M1_presound,~,p_prefer_presound(4,:),p_nonprefer_presound(4,:)]  =...
    process_ME_ephys_regress_step1_20240628('altern_M1_20240427',root_dir,1);
[Coef_STR_presound,~,p_prefer_presound(5,:),p_nonprefer_presound(5,:)]  = ...
    process_ME_ephys_regress_step1_20240628('altern_STR_20240427',root_dir,1);
toc
