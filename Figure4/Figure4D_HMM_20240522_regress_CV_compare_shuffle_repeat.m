...
function Figure4D_HMM_20240522_regress_CV_compare_shuffle_repeat

[OFC_p, OFC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('repeat_OFC_20240427');
[Hippo_p, Hippo_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('repeat_Hippo_20240427');
[AC_p, AC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('repeat_AC_20240427');
[PPC_p, PPC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('repeat_PPC_20240427');
close all
...
disp([OFC_neuron(number,1:2); Hippo_neuron(number,1:2); AC_neuron(number,1:2); PPC_neuron(number,1:2)])

disp([OFC_neuron(number,3); Hippo_neuron(number,3); AC_neuron(number,3); PPC_neuron(number,3)])
...
if ~exist('shuffle_MS', 'var')
    ...
    %sig_before_sound = get_sig_neuron_time_window(p_task,new_p_thre,[13:15]); %300ms before sound
