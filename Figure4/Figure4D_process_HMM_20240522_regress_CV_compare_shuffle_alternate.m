...
----------------------------------------------------------------------------
%}
function Figure4D_process_HMM_20240522_regress_CV_compare_shuffle_alternate

[OFC_p, OFC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_OFC_20230427');
[Hippo_p, Hippo_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_Hippo_20230427');
[AC_p, AC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_AC_20230427');
[PPC_p, PPC_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_PPC_20230427');
[M1_p, M1_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_M1_20230427');
[STR_p, STR_neuron] = temp_HMM_20240522_regress_CV_compare_shuffle('zigzag_STR_20230427');
close all
...
[OFC_neuron(number,1:2); Hippo_neuron(number,1:2); AC_neuron(number,1:2); ...
    PPC_neuron(number,1:2); M1_neuron(number,1:2); STR_neuron(number,1:2)]

[OFC_neuron(number,3); Hippo_neuron(number,3); AC_neuron(number,3); ...
