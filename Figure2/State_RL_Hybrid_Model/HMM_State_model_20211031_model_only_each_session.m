...
function [ave_likeli,BIC_all,log_likeli,para_max,N_trial] = ...
    HMM_State_model_20211031_model_only_each_session(Correct_trial, Chosen_trial, binary_tone, Reward_LCR)
...
for j = 1:length(use_para)
    ...
    %for i = 1:size_y
        ...
        [X1(i,:),FCAL1(i,:),EXITFLAG,OUTPUT] = ...
            fminsearch(@HMM_State_update_211031_all,para_temp(i,:), opt, Correct_trial, reward_trial, Chosen_trial, binary_tone, bin_x, stim_LR, stim_prob_LR, init_Q, temp_use_para);
    end
    min_FCAL = find(FCAL1 == min(FCAL1),1);
    temp_para_max = X1(min_FCAL,:);

    [ave_likeli(1,j),likelihood,Q,Choice_prob,para_max(j,:),state_prob] = ...
        HMM_State_update_211031_max_all(temp_para_max, Correct_trial, reward_trial, Chosen_trial, binary_tone, bin_x, stim_LR, stim_prob_LR, init_Q, temp_use_para);
...
function [ave_likeli,likelihood,prob_LH,Choice_prob,para,state_prob] = ...
    HMM_State_update_211031_max_all(para, Correct_trial, reward, action, Stim_freq, bin_x, stim_LR, stim_prob_LR, init_Q, use_para)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ave_likeli_mean = HMM_State_update_211031_all(para, Correct_trial, reward_trial, Chosen_trial, binary_tone, bin_x, stim_LR, stim_prob_LR, init_Q, use_para)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

[ave_likeli_mean,~] = ...
    HMM_State_update_211031_max_all(para, Correct_trial, reward_trial, Chosen_trial, binary_tone, bin_x, stim_LR, stim_prob_LR, init_Q, use_para);
ave_likeli_mean
return
