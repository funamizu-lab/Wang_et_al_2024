...
function Figure1HMM_psycho_full_model_Gauss_20240710

filename1 = 'Bpod_mat_210202_May27-2021_Session1_mouse17.mat';
filename2 = 'Bpod_mat_210202_Aug06-2021_Session1_mouse02.mat';
plotPsychometric(filename1)
plotPsychometric(filename2)

function plotPsychometric(filename)
[~,tone_evidence,trial_evidence,trial_remove_first,...
    low,high,~,~,~,~,~,...
    ~,~,~,right_trial,number_trial] ...
 = HMM_get_basic_task_structure_20210514(filename);
