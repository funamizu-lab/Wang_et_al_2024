function FigureS4B_top_MotionEnergy_example_session_20240521(root_dir)

pathname = '/DLC_data/W27/20220908';
path1 = [root_dir pathname];
...
for i=1:length(use_trial_remove_first)
    ...
    ME_presound(i) = mean(allME(Frame_presound));
...
plot_mean_se_moto(allME,'k',2);
xticks(0:1000:trial_time)
xticklabels({'-2000','-1000','0','1000','2000','3000'})
ylim([0.25,0.5])
xlabel('trial time')
ylabel('Nomalized total facial motion')
