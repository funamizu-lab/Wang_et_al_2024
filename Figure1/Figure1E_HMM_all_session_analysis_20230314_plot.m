...
function HMM_all_session_analysis_20230314_plot
...
%Analysis
analysis_repeat_zigzag(repeat_first_day, zigzag_first_day,repeat_first,zigzag_first)
analysis_repeat_zigzag(repeat_first_day2, zigzag_first_day2,repeat_first2,zigzag_first2)

return

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function analysis_repeat_zigzag(repeat_first_day, zigzag_first_day,repeat_first,zigzag_first)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure
plot_mean_se_moto(repeat_first,[0.5 0.5 0.5],2)
hold on
plot_mean_se_moto(zigzag_first,[0 0 0],2)
